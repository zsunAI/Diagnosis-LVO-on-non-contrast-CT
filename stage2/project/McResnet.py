...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1):
        ...
        self.conv1 = nn.Conv3d(4, 64, kernel_size=7, stride=(2, 2, 2), padding=(3, 3, 3), bias=False)
        # If it is 3-channels input, change it to nn.Conv3d (3,...)
...
# 
# test:(batch_size, channels, depth, height, width) 
